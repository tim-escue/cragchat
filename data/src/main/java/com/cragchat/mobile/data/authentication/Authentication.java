...
public class Authentication {
    ...
    @Inject
    public Authentication(Context applicationContext, ClimbrRemoteDatasource remoteDatasource) {
        mProvider = new CragChatRestAuthenticationProvider(applicationContext, remoteDatasource);
    }

...
public class RealmDatabase implements ClimbrLocalDatabase {
    ...
    public void update(final Image image) {
        doInBackGround(realm -> realm.insertOrUpdate(RealmImage.from(image)));
    }

    @Override
    public void update(final Send send) {
        doInBackGround(realm -> realm.insertOrUpdate(RealmSend.from(send)));
    }

    @Override
    public void updateImages(final List<Image> images) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(images, RealmImage::from)));
    }
    ...
    public void updateSends(final List<Send> sends) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(sends, RealmSend::from)));
    }
    ...
    public void update(final Route route) {
        doInBackGround(realm -> realm.insertOrUpdate(RealmRoute.from(route)));
    }
    ...
    public void updateComments(final List<Comment> comments) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(comments, RealmComment::from)));
    }

    @Override
    public void updateRoutes(final List<Route> routes) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(routes, RealmRoute::from)));
    }
    ...
    public void updateRatings(final List<Rating> ratings) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(ratings, RealmRating::from)));
    }

    @Override
    public void updateAreas(final List<Area> areas) {
        doInBackGround(realm -> realm.insertOrUpdate(FormatUtil.transformList(areas, RealmArea::from)));
    }

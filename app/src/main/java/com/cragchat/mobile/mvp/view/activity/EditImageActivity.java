...
import com.cragchat.mobile.data.local.realm.RealmArea;
import com.cragchat.mobile.data.local.realm.RealmRoute;
import com.cragchat.mobile.mvp.view.ImageEditView;
import com.cragchat.mobile.mvp.view.fragments.ColorPickerDialog;
...
import static com.cragchat.mobile.util.ViewUtil.ENTITY_KEY;
    ...
    public void onSubmit() {
        ...
        try {
            ...
            try {
                ...
                if (entity instanceof RealmRoute) {
                    ViewUtil.launch(this, ((RealmRoute) entity).getKey());
                } else {
                    ViewUtil.launch(this, ((RealmArea) entity).getKey());
                }
            } catch (IOException e) {
                e.printStackTrace();
            }

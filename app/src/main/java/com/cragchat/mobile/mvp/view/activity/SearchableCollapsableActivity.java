...
public abstract class SearchableCollapsableActivity extends CragChatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Intent intent = new Intent(SearchableCollapsableActivity.this, SearchActivity.class);
            ...
            public boolean onQueryTextChange(final String s) {
                ...
                if (s.isEmpty()) {
                    ...
                    data = repository.getQueryMatches(s, list -> {

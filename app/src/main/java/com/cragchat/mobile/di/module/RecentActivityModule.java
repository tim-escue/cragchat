...
@Module(includes = {ApplicationModule.class, Repository.class})
public class RecentActivityModule {

    private RecentActivityFragment mFragment;

    public RecentActivityModule(RecentActivityFragment fragment) {
        this.mFragment = fragment;
    }

    @Provides
    Area provideArea() {
        return mFragment.getArguments().getParcelable(ENTITY_KEY);
    }
